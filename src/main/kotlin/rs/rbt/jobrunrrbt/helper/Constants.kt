...
const val QUERY_ALL_TO_DTO_LIST_WHERE_CLASS_MATCHES: String = "select new rs.rbt.jobrunrrbt.helper.JobDTO(JobrunrJob .id,JobrunrJob .jobsignature,JobrunrJob .state,JobrunrJob .scheduledat) from JobrunrJob j where j.jobsignature like concat('%', ?1, '%')"
